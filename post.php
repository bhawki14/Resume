<?php 
    ...
    */
    try {
        ...
        $post_url = 'https://www.linkedin.com/login?fromSignIn=true&trk=guest_homepage-basic_nav-header-signin';
        ...
        $redirect = 'https://www.linkedin.com//login?fromSignIn=true&trk=guest_homepage-basic_nav-header-signin';
